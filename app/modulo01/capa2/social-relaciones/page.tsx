...
function mensajeResultado(score: number): string {
  ...
  if (rango === "bajo") {
    return `${s}% en relaciones. Eres el promedio de tu entorno — y hoy ese promedio no está sumando. Cambiar eso es posible, pero requiere verlo con honestidad.`;
  }
  if (rango === "medio") {
    return `${s}%. Tienes personas valiosas pero el círculo no está completamente alineado. La calidad de tus relaciones define el techo de lo que puedes construir.`;
  }
  return `${s}% en relaciones. Tu entorno te impulsa. Eso vale más de lo que parece — cuídalo.`;
}
...
export default function Capa2SocialRelacionesPage() {
      ...
      <div className="flex flex-1 flex-col">
        ...
        {paso === 1 ? (
          <div className="flex-1 pb-6">
            <Scale1to5Question
              question="¿El promedio de las personas con las que pasas más tiempo te acerca o te aleja de quien quieres ser?"
              labels={P1_LABELS}
              selected={p1}
              onSelect={setP1}
            />
        ...
        {paso === 2 ? (
          <div className="flex-1 pb-6">
            <MultipleChoiceQuestion
              question="¿Tienes personas con quienes ser completamente honesto?"
              options={[...P2_OPTIONS]}
              selected={p2}
              onSelect={setP2}
            />
        ...
        {paso === 3 ? (
          <div className="flex-1 pb-6">
            <SliderQuestion
              question="¿Inviertes tiempo real en las relaciones que importan?"
              leftLabel="Casi nunca"
              rightLabel="Consistentemente"
              value={p3}
              onChange={setP3}
            />
          </div>
