...
export default function Modulo03CierreClient({
  hasSession,
}: {
  hasSession: boolean;
}) {
    ...
    <main className="min-h-screen bg-[#0D0D14] px-6 py-10 text-[#F0EDE8] md:px-8">
      <div className="mx-auto w-full max-w-2xl space-y-10">
        ...
        >
          ...
          <Link
            href="/modulo04"
            className="block w-full rounded-lg bg-[#C9A84C] py-3.5 text-center font-medium text-[#0D0D14] transition-colors duration-200 hover:bg-[#C9A84C]/90"
          >
            Comenzar Módulo 04 →
          </Link>
          <button
